	...
	$prefs->init(
		{
			...
			trackdisplayline1 => Plugins::BBCSounds::ProtocolHandler::DISPLAYLINE_TRACKBYARTIST,
			trackdisplayline2 => Plugins::BBCSounds::ProtocolHandler::DISPLAYLINE_PROGRAMMEDESCRIPTION,
